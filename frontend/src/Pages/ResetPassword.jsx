  ...
  if (!token) {
    return (
      <section className="bg-slate-50 font-sans min-h-screen flex items-center justify-center pt-20 pb-12 px-4 sm:px-6">
        <div className="w-full max-w-md bg-white rounded-lg border border-slate-200 overflow-hidden p-8 text-center">
    ...
    <section className="bg-slate-50 font-sans min-h-screen flex items-center justify-center pt-20 pb-12 px-4 sm:px-6">
      <div className="w-full max-w-md bg-white rounded-lg border border-slate-200 overflow-hidden">
        ...
        <form onSubmit={handleReset} className="p-8">
          ...
          <button 
            type="submit" 
            className="w-full py-2.5 px-4 text-sm font-semibold text-white bg-blue-600 rounded-md hover:bg-blue-700 transition-colors mb-4"
          >
            Update Password
          </button>
