    ...
    <div className="w-full bg-slate-50 min-h-screen font-sans selection:bg-blue-100 selection:text-blue-900">
      ...
      <div className="pt-24 lg:pt-40 pb-20 px-6 lg:px-8 max-w-4xl mx-auto flex flex-col items-center text-center gap-8 z-10">
        ...
        <p className="text-lg md:text-xl text-slate-600 max-w-2xl leading-relaxed">
          LabZip provides secure, blazing-fast cloud storage for your academic work. Upload directly to the cloud with zero server bottlenecks.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 w-full sm:w-auto">
          ...
          <Link to="https://github.com/Kartik-369/LabZip" className="w-full sm:w-auto px-8 py-4 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-semibold rounded-xl shadow-sm transition-all duration-200 active:scale-95 flex items-center justify-center gap-2 text-lg">
      ...
      {/* Features Grid */}
      <div id="howitworks" className="max-w-7xl mx-auto px-6 py-24 scroll-mt-20">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            Everything you need in a cloud drive
          </h2>
          <p className="text-lg text-slate-600">
            LabZip stripped away the complexity to give you a blazing fast, secure, and intuitive tool for managing your college coursework.
          </p>
        </div>
