              ...
              {displayedFiles.map((file) => (
                <div key={file._id} className="bg-white p-4 rounded-xl border border-slate-200 hover:border-slate-300 shadow-xs hover:shadow-sm transition-all group flex flex-col">
                  ...
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <button onClick={(e) => handleDelete(e, file._id)} title="Delete File" className="text-slate-400 hover:text-red-500 p-1 rounded hover:bg-red-50 opacity-0 group-hover:opacity-100 transition-all">
